...
//
// Emits two files:
//   dist/djvu.h  -- the public API header (verbatim copy of include/djvu.h)
...
const publicHeader = readFileSync(join(ROOT, "include", "djvu.h"), "utf8");
...
parts.push(
  `/* djvu.c -- single-file amalgamation of the C DjVu decoder.\n` +
    ...
    ` * under src/ and include/ and regenerate with \`bun cmd/build-dist.ts\`.\n` +
    ` *\n` +
